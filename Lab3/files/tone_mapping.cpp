...
// // gather function
// static void gather(int gather_id, int id, int tc, int use_sense, int *local_sense)
// {
//     if (use_sense){
//         rbarrier_wait(&sense_barrier, local_sense);
//     } else {
//         diy_gate_barrier_wait(&diy_barrier);
//     }
